...
```text
to-java.xsl              59137  39.44%
classes.xsl              47597  31.75%
set-locators.xsl         10659  7.11%
set-original-names.xsl   7940   5.30%
attrs.xsl                5364   3.58%
data.xsl                 4982   3.32%
anonymous-to-nested.xsl  4903   3.27%
tests.xsl                4766   3.18%
package.xsl              4575   3.05%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-07-22 at 16:08,
on Linux with 4 CPUs.
The total is 149923 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/29935822928
